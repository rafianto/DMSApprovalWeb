...
@section('title', 'Overview History')
@section('header-title-content', 'Overview History')
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="table-responsive">
                <table id="tblOverviewHistory" class="table table-bordered table-striped" width="100%">
                    <thead>
                    <tr>
                        <th>DMS No</th>
                        <th>Created Date</th>
...
@push('script')
    <script>
        ...
        window.open(`/historypdf/${base64DmsNo}`, "_blank");
